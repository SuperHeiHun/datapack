...
tellraw @a [{"text":"[Kill Attack Cooldown]","color":"#00bfff"},{"text":"数据包未进行初始化设置","color":"white"},{"text":"点我进行初始化设置","color":"#00ff7f","clickEvent":{"action":"suggest_command","value":"/function kill_attack_cooldown:setting/set_mode"}}]
